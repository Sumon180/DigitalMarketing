      ...
      <div className="max-w-[1200px] w-full mx-auto py-14">
        ...
        <div className="mt-[90px] grid grid-cols-3 gap-16">
          {services.map((service) => (
            <div className="flex flex-col justify-between bg-gradient-to-b from-[#36363E] to-[#292930] rounded-[30px] border border-[#424245] p-[40px]">
              <div>
              ...
              <div className="flex flex-col gap-4">
                ...
                <button className="w-full flex items-center justify-center gap-2 px-5 py-2 rounded border border-[#535355] hover:bg-[#FFDC60] text-[#525255] font-medium">
                  Read More
